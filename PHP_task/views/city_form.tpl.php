<div class="container-sm pt-5" style="max-width: 650px;">
	<div class="form-group col-lg-12">
		<div class="alert alert-primary" role="alert">
		  <h5 class="alert-heading">Redaguojamas miestas: <?php echo $this->model->getCity($id)['Name']; ?></h5>
		</div>
	</div>
	<form method="post" class="pt-4">
	  ...
	  <div class="form-group col-lg-12">
		<label for="Area">Miesto plotas</label>
	  ...
	  <div class="form-group col-lg-12">
		<label for="Population">Miesto gyventojų skaičius</label>
	  ...
	  <div class="form-group col-lg-12">
		<label for="Postal_Code">Miesto pašto kodas</label>
